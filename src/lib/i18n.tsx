...
const t = {
  fr: {
    ...
    categories: {
      ...
      explore: 'Catégories',
      women: 'Femme',
      womenSub: 'Soins & beauté femme',
      men: 'Homme',
      menSub: 'Soins & beauté homme',
      accessories: 'Accessoires',
      accessoriesSub: 'Accessoires beauté',
      newArrivals: 'Nouveautés',
      newArrivalsSub: 'Derniers arrivages',
    },
    featured: {
      label: 'Sélection',
      title: 'Soins du Moment',
      viewAll: 'Tout voir',
    ...
    footer: {
      tagline: 'Beauté Premium',
      description: 'Soins & beauté premium sélectionnés et livrés dans le monde entier. Qualité garantie, livraison rapide.',
      shop: 'Boutique',
      ...
      worldwide: 'Livraison mondiale — Beauté & Skincare premium',
    },
    products: {
  ...
  en: {
    ...
    categories: {
      ...
      explore: 'Coming Soon',
      women: 'Women',
      womenSub: 'Skincare & beauty for women',
      men: 'Men',
      menSub: 'Skincare & grooming for men',
      accessories: 'Accessories',
      accessoriesSub: 'Beauty tools & accessories',
      newArrivals: 'New Arrivals',
    ...
    footer: {
      tagline: 'Beauty Premium',
      description: 'Premium beauty & skincare curated and delivered worldwide. Quality guaranteed, fast shipping.',
      shop: 'Shop',
      collection: 'Collection',
      newArrivals: 'New Arrivals',
      women: 'Women',
      ...
      worldwide: 'Worldwide delivery — Premium Beauty & Skincare',
    },
    products: {
