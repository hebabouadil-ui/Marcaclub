...
const t = {
  fr: {
    ...
    cart: {
      ...
      unit: '/ unité',
      calculated: 'Calculé',
      estimatedDays: 'Estimé',
      days: 'jours',
      weightExceeded: 'Votre panier dépasse 1,9 kg. Retirez des articles pour continuer.',
      cartTooHeavy: 'Panier trop lourd',
      securePayment: 'Paiement sécurisé',
  ...
  en: {
    ...
    cart: {
      ...
      estimatedDays: 'Est.',
      days: 'days',
      weightExceeded: 'Your cart exceeds the 1.9 kg limit. Remove items to continue.',
      cartTooHeavy: 'Cart too heavy',
      securePayment: 'Secure Payment',
