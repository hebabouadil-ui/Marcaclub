...
const t = {
  fr: {
    ...
    hero: {
      badge: 'Livraison mondiale · Paiement sécurisé',
    ...
    live: {
      title: 'Live Shopping',
      subtitle: 'Rejoignez nos Lives',
      description: 'Découvrez nos nouvelles collections en avant-première lors de nos sessions live sur Instagram et TikTok. Commandes en direct, prix exclusifs.',
  ...
  en: {
    ...
    hero: {
      badge: 'Worldwide Shipping · Secure Checkout',
      shopNow: 'Shop Now',
    ...
    live: {
      title: 'Live Shopping',
      subtitle: 'Join our Lives',
      description: 'Discover our new collections first during our live sessions on Instagram and TikTok. Live orders, exclusive prices.',
      liveNow: 'LIVE now',
      joinInstagram: 'Instagram Live',
      joinTikTok: 'TikTok Live',
