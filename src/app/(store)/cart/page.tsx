  ...
  if (items.length === 0) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-center px-4">
        ...
        <h1 className="font-display text-3xl text-brand-black mb-3">Your cart is empty</h1>
        <p className="text-brand-gray text-sm mb-8">Explore our collection and add your favorites.</p>
        <Link
          href="/products"
  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16">
        <h1 className="font-display text-3xl md:text-4xl text-brand-black mb-10">My Cart</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="bg-brand-light-gray p-6 sticky top-24">
              <h2 className="text-xs tracking-[0.2em] uppercase text-brand-gray mb-6">Order Summary</h2>
              ...
              <div className="border-t border-brand-beige pt-4 mb-6">
                ...
                <p className="text-xs text-brand-gray mt-1">Shipping calculated at checkout</p>
              </div>
