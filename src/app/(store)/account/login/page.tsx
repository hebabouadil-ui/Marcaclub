    ...
    <div className="min-h-[calc(100vh-200px)] flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="font-display text-3xl font-bold text-brand-white tracking-widest uppercase mb-2">Sign In</h1>
          <p className="text-white/40 text-sm">Access your orders and account</p>
        </div>
        <div className="bg-white/3 border border-white/8 p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-white/40 text-[10px] tracking-widest mb-2">EMAIL</label>
            ...
            <div>
              <label className="block text-white/40 text-[10px] tracking-widest mb-2">PASSWORD</label>
              <div className="relative">
          ...
          <p className="text-center text-white/30 text-sm mt-6">
            No account?{' '}
            <Link href="/account/register" className="text-brand-gold hover:text-yellow-400 transition-colors">Create one</Link>
          </p>
        </div>
      </div>
    </div>
