...
const categories = [
  { label: 'Pyjamas', value: 'pyjamas', description: 'Sets, shorts, combinaisons' },
  { label: 'Robes de nuit', value: 'robes-de-nuit', description: 'Longues, courtes, satin' },
  { label: 'Lingerie', value: 'lingerie', description: 'Soutiens-gorge, culottes' },
    ...
    <section className="py-16 md:py-24 bg-brand-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-4xl text-brand-black">Nos Collections</h2>
        </motion.div>
