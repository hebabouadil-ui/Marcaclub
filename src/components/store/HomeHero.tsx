...
export default function HomeHero({ title, subtitle, titleEn, subtitleEn }: Props) {
  ...
  return (
    <section className="relative bg-brand-black flex items-start md:items-center justify-center overflow-hidden min-h-screen md:min-h-[75svh]">
      {/* Background */}
      ...
      <div className="relative z-10 text-center px-5 max-w-4xl mx-auto pt-10 pb-20 md:py-20 md:pb-24">
        ...
        {/* Trust bar — always row on mobile with smaller text */}
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.2 }}
        className="absolute bottom-5 md:bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2">
        <span className="text-white/20 text-[9px] tracking-[0.3em] uppercase">Scroll</span>
        <div className="w-px h-8 md:h-10 bg-white/10 relative" style={{ overflow: 'hidden', isolation: 'isolate' }}>
          <motion.div
